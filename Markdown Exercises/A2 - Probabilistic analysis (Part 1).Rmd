...
A template for the exercise, ‘Exercise 4.7 – template.R’, is available, based on the solution to **Exercise 2.5** adapted to allow additional information to be entered (JACK - this needsd to be changed?).
