...
The final task is simply to create an output matrix by running the code in the "Analysis" section and the to to calculate the appropriate the ICER by completing the blank `output["icer"]`.
