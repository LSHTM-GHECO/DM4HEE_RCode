...
i) First create an empty trace matrix of the right dimensions - we can call this `trace.AZT` (L98 in the template document). The data, number of rows, and number of columns have been left blank for you to add in. 
