...
We mention "sections" within the R scripts for this course, similar to how you might refer to sheets in Excel. If you are using RStudio, sections can be selected using the bottom left of the Source panel or alternativly using the document outline functionality (top right of the Source panel).
