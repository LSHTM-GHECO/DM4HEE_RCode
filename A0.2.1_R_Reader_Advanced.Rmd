...
Another important aspect of the course is selecting the appropriate data. For the various vectors, data frames and arrays, here are some way tp select data:
