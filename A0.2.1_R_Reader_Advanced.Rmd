...
# Note that if we tried "cost %*% people" this would result in: 
# "Error in cost %*% people : non-conformable arguments"
# This is because the number of columns/values in cost (n=3) does not equal the number of
# rows/values in people (n=4). 
# We also wouldn't want the product of this calculation, even if these dimension lengths 
# match, as that would multiply the wrong values together - For example ...
