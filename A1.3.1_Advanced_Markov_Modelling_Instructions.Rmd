...
*Hint: If you get a non-comformable error, make sure you're only selecting the relevant matrix from `tm.SP0`. Refer back to the reader for some more information on matrix multiplication in R* 
