...
Try re-running the model for a different sex and age groups (between 40 and 90 years), and/or different discount rates, and see differences in the results produced. *Hint:go back to the top of your model R script and adapt the`age` and `male` assignments and rerun.*
