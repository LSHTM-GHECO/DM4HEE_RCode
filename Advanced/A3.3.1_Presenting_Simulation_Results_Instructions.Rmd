...
We now need to set up a new function `model.THR.3b()`. Use `model.THR()` as the base and update/create the following variables within the new function (`model.THR.3b()`):
*
