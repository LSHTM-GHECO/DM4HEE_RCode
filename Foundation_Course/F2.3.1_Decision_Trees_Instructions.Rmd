...
v) Now onto the analysis (within the "Analysis" section: Once you have the costs and cases associated with the testing arm and no testing arm of the decision tree, use these to calculate the incremental costs and the cases avoided, and calcualte the expected cost per HIV infected child avoided.
