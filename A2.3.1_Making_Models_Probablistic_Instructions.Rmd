...
ii) Use the `rbeta()` function to generate a random draw from this distribution to define `tp.PTHR2dead`. Note that the rbeta function takes 3 arguments, first the number of draws or samples, the alpha parameter (named shape1) and the beta parameter (named shape2). Check the following code to see a demonstration. 
